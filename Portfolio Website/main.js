...
themeToggle.addEventListener('change', () => {
    ...
    if (themeToggle.checked) {
        // Dark mode
        root.style.setProperty('--black-100', '#2b2b2b');
        root.style.setProperty('--white', '#fff');
        root.style.setProperty('--black-alpha-100', 'rgba(255, 255, 255, 0.05)');
        document.body.style.backgroundColor = '#2b2b2b';
        document.body.style.color = '#fff';
    } else {
        // Light mode (restore default values)
        root.style.setProperty('--black-100', '#f7f7f7');
        root.style.setProperty('--white', '#000');
        root.style.setProperty('--black-alpha-100', 'rgba(0, 0, 0, 0.05)');
...
var typed = new Typed('.auto-type', {
    strings: ["Enthusiast.", "Student.", "Aspirant."],
    typeSpeed: 50,
    backSpeed: 50,
    loop: true,
